...
export function TryHackMeSection() {
  ...
  return (
    <SectionPremium id="tryhackme" spacing="normal" accentLine="top">
      ...
      <p className="text-text-secondary mx-auto mb-12 max-w-3xl text-center text-lg leading-relaxed">
      ...
      <div className="border-border-subtle mx-auto mb-12 grid max-w-3xl grid-cols-1 gap-px overflow-hidden border-y sm:grid-cols-3">
        {THM_STATS.map((stat) => (
      ...
      {thmUrl && (
        <div className="mt-10 text-center">
          <a
            ...
            className="hover:text-accent-hover inline-flex items-center gap-2 font-mono text-sm font-medium text-accent transition-colors duration-200"
          >
