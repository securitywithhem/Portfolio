...
export async function GitHubCard({ url }: { url: string }) {
  ...
  return (
    <a
      ...
      className="group bg-bg-base hover:bg-bg-surface flex h-full flex-col gap-4 p-6 transition-colors duration-200 sm:p-8"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <h3 className="text-text-primary mt-2 truncate text-base font-semibold tracking-tight transition-colors duration-200 group-hover:text-accent sm:text-lg">
            {repo}
          </h3>
        </div>
        <ArrowUpRight
      ...
      {metadata && (
        <div className="text-text-muted mt-auto flex flex-wrap gap-4 pt-2 text-xs">
