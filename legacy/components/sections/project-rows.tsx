  ...
  return (
    <>
      <motion.ol
        ...
        className="border-border-subtle list-none border-t"
      >
          ...
          >
            <Dialog>
              <DialogTrigger asChild>
                ...
                >
                  <span className="text-text-muted font-mono text-xs tabular-nums transition-colors duration-200 group-hover:text-accent">
                    {String(i + 1).padStart(2, "0")}
                  </span>

                  <span className="min-w-0 flex-1">
                    <span className="flex items-center gap-3">
                      <span className="text-text-primary truncate text-2xl font-bold tracking-tight transition-colors duration-200 group-hover:text-accent md:text-4xl">
                        {project.title}
                      </span>
                      {project.featured && (
                    ...
                    <span className="text-text-muted mt-2 block truncate text-sm">
                  ...
                  <span
                    aria-hidden
                    className="text-text-muted shrink-0 text-xl transition-all duration-200 group-hover:translate-x-1 group-hover:text-accent"
                  >
                    →
                  </span>
                </button>
      ...
      <AnimatePresence>
        {hovered && hover && (
          <motion.div
            ...
            className="border-border-subtle bg-bg-surface pointer-events-none fixed z-50 hidden aspect-video w-72 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-md border lg:block"
          >
            {cover ? (
              <Image
                src={cover}
              ...
              <div className="flex size-full flex-col items-center justify-center gap-2">
                ...
                <span className="text-text-secondary px-4 text-center text-sm font-medium">
                  {hovered.title}
                </span>
              </div>
            )}
